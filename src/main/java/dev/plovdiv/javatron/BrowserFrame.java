package dev.plovdiv.javatron;// Copyright (c) 2014 The Chromium Embedded Framework Authors. All rights
...
class BrowserFrame extends JFrame {
     ...
     */
    BrowserFrame(String startURL, boolean useOSR, boolean isTransparent, String[] args) throws UnsupportedPlatformException, CefInitializationException, IOException, InterruptedException {
        ...
        //add custom menu handler for the dev tools
        cefClient.addContextMenuHandler(new ContextMenuHandler(BrowserFrame.this));

        browerUI = cefBrowser.getUIComponent();
        ...
        address_.addActionListener(e -> cefBrowser.loadURL(address_.getText()));
